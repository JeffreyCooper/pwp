					...
					<div class="container-fluid">
						...
						<div class="navbar-header">
							<a class="navbar-brand">
								<img alt="Jeffrey Cooper" src="public_html/JC-logo3.gif">
							</a>
...
<!--											Bootstrap Card attribute for breadcrumb links-->
											<div class="card text-left" style="width: 16rem">
												<img class="card-img-top" src="public_html/images/screen-160x120.jpg" alt="Portfolio">
										...
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="card text-left" style="width: 16rem">
												<img class="card-img-top" src="public_html/images/code-160x120.jpg" alt="Experience">
										...
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="card text-left" style="width: 16rem">
												<img class="card-img-top" src="public_html/images/sheba-jeff-160x120.jpg" alt="Contact">
...
<!--								Portfolio header -->
								<div class="row">
									<div class="col-xs-12">
										<p>For the past twenty years, Jeffrey Cooper has been building websites. What was once a
											hobby has now become a profession. The websites listed below were all built from
											scratch. Many more were built, maintained, rebuilt and expanded in industries such as
											Real Estate, Medical Services, Authors, Mental Health Services, Theater, Music,
											Workshops, Consultants and Schools to name a few.</p>
									</div>
								</div>
								<div class="row">
<!--									PacRim Box-->
									<div class="col-xs-12 col-md-6">
										<div class="box1">
											<img src="public_html/images/pacrim_logo.gif" alt="Pacific Rim Children/'s Chorus Festival">
											<p>The Pacific Rim Children's Chorus Festival was launched in 1999 as a new type of
												...
												became the most successful festival of its kind, setting a new bar for music
												festivals around the world. The Festival's website was the first to provide
												almost-live media to families back home, as well as pedagogical tools for over 5000
												students.</p>
										</div>
									</div>
<!--									SWMA Box-->
									<div class="col-xs-12 col-md-6">
										<div class="box1">
											<img src="public_html/images/SWMA-logo.jpg" alt="Soutwest Miniature Art">
...
<!--									Summer Fun Box-->
									<div class="col-xs-12 col-md-6">
										<div class="box1">
											<img src="public_html/images/summerfun-jpg.gif" alt="Summer Fun Camp">
											<p>A summer arts camp for kids, Summer Fun in Seattle, WA, helped launch the company in
												...
												five musicals that were staged and performed twice each summer for the public.</p>
										</div>
									</div>
<!--									Kodaly Box-->
									<div class="col-xs-12 col-md-6">
										<div class="box1">
											<img src="public_html/images/kodaly-logo.gif" alt="Northwest Kodaly Educators">
...
<!--									CCR Box-->
									<div class="col-xs-12 col-md-6">
										<div class="box1">
											<img src="public_html/images/ccr-jpg.jpg" alt="Choral Conductors Retreat">
											<p>Dr. Rodney Eichenberger, a world-renowned choral music conductor, asked Jeffrey
												...
												Oregon and Virginia. He rebranded and grew the company into the premier choral music
...
<!--									HYOC Box-->
									<div class="col-xs-12 col-md-6">
										<div class="box1">
											<img src="public_html/images/45hyoc.png" alt="Hawaii Youth Opera Chorus">
...
<!--							Education card-block -->
							<div class="card-block col-xs-12" id="card-big-exp">
								<div class="tab-content">
									<div id="education" class="tab-pane fade in active" role="tabpanel">
										...
										<p>Bachelor of Arts - BA in Music, Vocal Performance, Music Education with a Minor in
											Theater - Magna cum laude</p>
									</div>
<!--									Experience card-block -->
									<div id="experience" class="tab-pane fade" role="tabpanel">
										<h3>Experience</h3>
										<p>Whether as an entrepreneur, artist, programmer or consultant, Jeffrey Cooper has always
											sought new and challenging experiences. After graduating from college, he traveled
											throughout Europe and lived in Brussels, Belgium and Moscow, Russia. Upon returning to
											the US, he started his first company providing travel services overseas. While pursuing
											a career as a musician, he taught himself programming and soon had a secondary career
											building websites at the birth of the World Wide Web.</p>
										<p>In addition to starting several more successful companies, he became a professor and
											was an adjudicator for music festivals across the country. He managed several employees
											in each of his start-ups and worked as an Operations Manager for several other
											organizations.</p>
...
<!--									Skills card-block -->
									<div id="skills" class="tab-pane fade" role="tabpanel">
										...
										<ul>
											...
											<li>PHP, mySQL, JavaScript, jQuery, Angular, RESTful Web Services, Secure Coding,
												UX-UI
											</li>
											<li>IT Services, Web Applications, Website Maintenance, Unit Testing, API Testing</li>
											<li>Professor, Teacher, Educator, Curriculum Development, Research, Music History,
												Music Theory
											</li>
											<li>Choral Conducting, Orchestral Conducting, Performing Arts, Theater, Music,
												Production, Musical Theater, Workshops
											</li>
							...
							<div class="panel-body">
								<div class="row panel-body">
									<div class="col-sm-6 col-sm-offset-3">
										<form id="contact-form" class="form-horizontal well" method="POST"
												action="public_html/php/mailer.php">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-4 col-md-offset-4">
								<p>&copy; Copyright 2017 | Jeffrey Cooper | All rights reserved.</p>
							</div>
						</div>
					</div>
				</footer>
