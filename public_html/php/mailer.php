...
try {
	...
	echo "<div class=\"alert alert-success\" role=\"alert\">Your message was successfully sent. Thank you!</div>";

} catch(Exception $exception) {
	echo "<div class=\"alert alert-danger\" role=\"alert\"><strong>Something went wrong!</strong> We were unable to send your email: " . $exception->getMessage() . "</div>";
}